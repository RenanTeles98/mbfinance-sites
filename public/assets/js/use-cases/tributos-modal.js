    ...
    function showQualified() {
        ...
        setContent(`
            <div class="trib-result">
                <div class="trib-result-icon success">✅</div>
                <h2>Seu perfil se enquadra!</h2>
                <p>Ótimo, sua empresa tem potencial para recuperar créditos de <strong style="color:#0099dd;">${product.label}</strong>.<br>Clique abaixo e um especialista vai te atender agora pelo WhatsApp.</p>
